...
function my_theme_register_required_plugins()
{
	...
	$plugins = array(
		array(
			'name'     				=> 'Mievent Custom Posts',
			'slug'     				=> 'tw_hero_slider',
			'source'   				  => get_template_directory() . '/includes/thirdparty/tgm-plugin-activation/plugins/tw_hero_slider.zip',
			'required' 				=> true,
			'version' 				 => '1.0',
			'force_activation' 		=> false,
			'force_deactivation' 	  => false,
			'external_url' 			=> get_template_directory_uri() . '/includes/thirdparty/tgm-plugin-activation/plugins/tw_hero_slider.zip',
		),
